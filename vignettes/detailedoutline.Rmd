...
- Video recordings: 4c-4f
- Course notes: Section 4.3 (excluding 4.3.3)


### In class:

- [Logistic and Poisson regression with **SAS**](https://raw.githubusercontent.com/lbelzile/statmod/master/code/60604A_glms.sas)
